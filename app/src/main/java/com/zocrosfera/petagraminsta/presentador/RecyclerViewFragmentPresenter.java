...
public class RecyclerViewFragmentPresenter implements IRecyclerViewFragmentPresenter {
    ...
    public RecyclerViewFragmentPresenter(IPerfilFragment iPerfilFragment, Context context, Activity activity){
...
//    }
    ...
    public void obtenerPhotoProfileFollower() {
        ...
        String defaultValue = "3639431388";
        String id = sharedPref.getString("id", defaultValue);

        Call<PhotoProfileFollowerResponse> followerResponseCall = endpointsApi.getRecentMediaById(id);
