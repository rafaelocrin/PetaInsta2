...
public class ProfileFollowerAdaptador extends RecyclerView.Adapter<ProfileFollowerAdaptador.ProfileFollowerViewHolder>{
    ...
    @Override
    public ProfileFollowerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_grid_profile_follower, parent, false);
        return new ProfileFollowerViewHolder(v);
    }

    @Override
    public void onBindViewHolder(ProfileFollowerViewHolder profileFollowerViewHolder, int position) {
        final ProfileFollowerViewHolder auxProfileFollowerViewHolder = profileFollowerViewHolder;
...
//        });
    ...
    public int getItemCount() {
        return photoProfileFollowers.size();
    }
