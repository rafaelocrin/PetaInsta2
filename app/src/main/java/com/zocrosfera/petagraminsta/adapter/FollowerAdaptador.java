...
//    }
    ...
    public FollowerAdaptador(ArrayList<Follower> followers, Activity activity, Context context){
...
//                editor.putString("id", follower.getId());
//                editor.commit();



                Intent intent = new Intent(activity, PerfilFragment.class);
                //intent.putExtra("id", follower.getId());
